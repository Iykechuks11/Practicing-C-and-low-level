...
def findRepeatSequencesSpacings(message):
    ...
    print(f'Sequence space: {seqSpacings}')
    return seqSpacings
...
def kasiskiExamination(ciphertext):
    ...
    print(f'Repeating sequence spacing: {repeatedSeqSpacings}')
    ...
    print(f'factorsByCount: {factorsByCount}')
    print(f'allLikelyKeyLengths: {allLikelyKeyLengths}')
