...
int main() {
  ...
  void *void_pointer; // A void pointer is a typeless pointer

  void_pointer = (void *) char_array; // void pointer must be typecast before any pointer arithmetic is performed
